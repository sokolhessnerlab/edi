function [output] = ildTask01(subjID,doHB,isreal,doprac)
...
try
    ...
    save(sprintf('ildTask_params_ILD%s_%.4f.mat',subjID,now),'output')
    ...
    save(sprintf('ildTask_ILD%s_%.4f.mat',subjID,now),'output')
